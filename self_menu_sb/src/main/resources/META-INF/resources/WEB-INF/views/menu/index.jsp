...
<meta charset="UTF-8">
<title>菜单管理</title>
<link rel="stylesheet" href="/lsb/menu/css/menu.css"/>
</head>
<body>
...
<script type="text/javascript" src="/lsb/menu/js/jquery.js"></script>
<script type="text/javascript" src="/lsb/menu/js/vue.js"></script>
<script type="text/javascript" src="/lsb/menu/js/menu.js"></script>
