package org.sbjava.weixin.library.comtroller;

import org.sbjava.weixin.library.domain.DebitList;
import org.sbjava.weixin.library.service.LibraryService;
...
@Controller
@RequestMapping("/lsb/library/debit")
...
public class DebitController {
	...
	public String debit(@RequestParam("id") String id, WebRequest request) {
		...
		return "redirect:/lsb/library/debit/list";
	}
